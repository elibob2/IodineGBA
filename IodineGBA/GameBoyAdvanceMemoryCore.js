...
GameBoyAdvanceMemory.prototype.compileMemoryDispatch = function (writeCalls, readCalls) {
...
GameBoyAdvanceMemory.prototype.fillWriteTableNOP = function (from, to) {
	//Fill in slots of the i/o write table:
	while (from <= to) {
		this.writeIO[from++] = this.NOP;
	}
}
GameBoyAdvanceMemory.prototype.compileIOReadDispatch = function () {
	this.readIO = [];
	//4000000h - DISPCNT - LCD Control (Read/Write)
...
GameBoyAdvanceMemory.prototype.fillReadTableUnused = function (from, to) {
